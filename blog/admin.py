...
class PostAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'status', 'created_on', 'updated_on')  # Fields to display in the list view
    list_filter = ('status', 'created_on', 'author')  # Add filters for status, creation date, and author
    search_fields = ('title', 'content')  # Add a search bar to search by title or content
